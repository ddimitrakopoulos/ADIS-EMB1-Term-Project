...
- **gin\_original.ipynb** contains the entire implementation of the GIN architecture, the dataset loading and esge case handling and the Classification, Clustering and Stability Analysis tasks all in separate cells, for better understanding of the code and its structure. 
